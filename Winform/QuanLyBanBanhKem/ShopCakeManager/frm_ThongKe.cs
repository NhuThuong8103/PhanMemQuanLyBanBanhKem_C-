...
namespace ShopCakeManager
{
    public partial class frm_ThongKe : Form
    {
        ...
        private void btn_QuayVeMenu_Click(object sender, EventArgs e)
        {
        ...
        private void dtgv_ThongKeHDBan_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            dtgv_ThongKeHDBan.Rows[e.RowIndex].Cells["STT"].Value = e.RowIndex + 1;
        }

        private void dtgv_ThongKePhieuDat_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            dtgv_ThongKePhieuDat.Rows[e.RowIndex].Cells["STT1"].Value = e.RowIndex + 1;
        }
    }
}